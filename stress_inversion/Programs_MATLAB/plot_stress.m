...
%--------------------------------------------------------------------------
h = figure; hold on; 
%title('Principal stress and P/T axes','FontSize',16);
...
plot(y_sigma_1,x_sigma_1,'mo','MarkerSize',18,'LineWidth',2.5);	% sigma_1
plot(y_sigma_2,x_sigma_2,'mx','MarkerSize',18,'LineWidth',2.5);	% sigma_2
plot(y_sigma_3,x_sigma_3,'m+','MarkerSize',18,'LineWidth',2.5);	% sigma_3
