...
%--------------------------------------------------------------------------
h = figure; hold on;
%title('Confidence of principal stress axes                 ','FontSize',16);
axis off; axis equal; axis([-1.05 1.70 -1.05 1.05]);

%--------------------------------------------------------------------------
% plotting the stress directions
plot(y_sigma_1,x_sigma_1,'r.','MarkerSize',22,'LineWidth',1.5);	% sigma_1
plot(y_sigma_2,x_sigma_2,'g.','MarkerSize',22,'LineWidth',1.5);	% sigma_2
plot(y_sigma_3,x_sigma_3,'b.','MarkerSize',22,'LineWidth',1.5);	% sigma_3
...
%--------------------------------------------------------------------------
% legend
hleg = legend('\sigma1','\sigma2','\sigma3');
set(hleg,'Location','SouthEast','FontSize',32)

    
%--------------------------------------------------------------------------
% saving the plot
%--------------------------------------------------------------------------
saveas(gcf,plot_file,'pdf');
