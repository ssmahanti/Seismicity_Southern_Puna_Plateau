...
do iiips=1,2
	...
	do i=1,nlev(iiips)
		...
		!write(*,*)ntop(iiips,i),ylevel(iiips,i)
	end do
	close(1)
...
!write(*,*)' nlev(1)=',nlev(1),' nlev(2)=',nlev(2)
			do n=1,nlev(ips)-1
				yl1=ylevel(ips,n)
				yl2=ylevel(ips,n+1)
                                !write(*,*)' n=',n,' yl1=',yl1,' yl2=',yl2
...
224			continue
			...
			iper=0
                       ! write(*,*)' ips=',ips,' nur1=',nur1,' notr(ips,nur1)=',notr(ips,nur1)
