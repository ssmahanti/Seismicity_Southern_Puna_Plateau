...
sub main()
{
    ...
    $cmd = "echo \"$title_x $title_y $TITLE_FONT_SIZE 0 1 BC Velocity anomalies in vertical sections. Area : $ar, Model : $md, Iteration : $iter\"";
    ...
    $xyz_out = sprintf("../../../TMP_files/hor/dv1%d%2d.grd.xyz",$iter,$N_SEC_HOR);
    ...
    $xyz_out = sprintf("../../../TMP_files/hor/dv2%d%2d.grd.xyz",$iter,$N_SEC_HOR);
	...
	$grd_in = sprintf("../../../TMP_files/vert/ver_1%d%2d.grd",$iter,$i+1);
	$xyz_out = $grd_in . ".xyz";
	...
	$grd_in = sprintf("../../../TMP_files/vert/ver_2%d%2d.grd",$iter,$i+1);
	$xyz_out = $grd_in . ".xyz";	
        $title = sprintf("S section %d",$i+1);
	convert2xyz($grd_in,$xyz_out);
