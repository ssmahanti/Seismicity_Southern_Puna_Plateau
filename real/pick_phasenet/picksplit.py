#Input file preperation for REAL. The amplitudes are set to be 0 by ssmahanti
...
pickfile =os.path.join('./result_gfz',direc,'picks.csv')
#print(pickfile)
output1 = 'temp.p'
output2 = 'temp.s'
prob_threshold = 0.5
...
for i in range(len(ppick_tmp)):
    ...
    ss = float(0) #starting point of a day
    ppick = []
    spick = []
    pprob = []
    sprob = []
